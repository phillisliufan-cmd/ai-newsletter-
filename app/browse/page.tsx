...
const SOURCE_GROUPS: { label: string; color: string; sources: string[] }[] = [
  {
    ...
    sources: ["openai", "anthropic", "deepmind", "huggingface", "microsoft", "meta_ai", "google_ai"],
  },
  {
    label: "财经 & 公司动态",
    color: "text-green-600",
    sources: ["reuters", "cnbc", "yahoo_fin"],
  },
  {
    label: "AI 媒体",
    color: "text-cyan-600",
    sources: ["venturebeat", "techcrunch", "theverge", "mit_review", "arstechnica", "wired_ai", "ai_news"],
  },
  {
    label: "Newsletter 博主",
    color: "text-pink-600",
